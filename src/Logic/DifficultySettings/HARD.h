...
public:
    ...
    HARD() {
        ...
        minDistance = 125.0f; ///< Set the minimum vertical distance between path platforms.
        maxDistance = 160.0f; ///< Set the maximum vertical distance between path platforms.
        maxHorizontalDistance = 205.0f;
        ChallengePlatformChance = 0.65f;
    }
};
